...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { nome: @institution.nome, notageral: @institution.notageral } }, as: :json
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { nome: @institution.nome, notageral: @institution.notageral } }, as: :json
    assert_response 200
  end
